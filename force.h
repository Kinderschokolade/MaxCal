...
//	if (dir == 1)  /////ignore potential in y-direction for now
//	{
...
//2D gaussiasn force ... Did I include the correction of Timon?
	...
	)
{
	...
	//	f[i] = F_gauss(x[i],k,U,xc,box[0]) + ext_f;
...
//	double Uscale = 8.*Uxsq / (box[1]*box[1]);
	int lvl = xm.size();
...
//	if (x[0] > box[0] || x[0] < 0 || x[1] > box[1] || x[1] < 0) 
//	{
///		cout<< "out of bound err" <<endl;
//		err = 1;
//	}
