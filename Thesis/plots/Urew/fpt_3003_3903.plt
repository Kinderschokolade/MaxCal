...
plot "../../data/Urew/hist_3903_3003.dat" u 0:6 pt 7 lc 6 ps .9 title "Reweight$: f=9~\\epsilon / \\mathcal{L} \\rightarrow f=0~\\epsilon / \\mathcal{L}$" ,\
"../../data/Urew/hist_3003_3903.dat" u 0:6 pt 6 lc 7 ps .9 title "Reweight$: f=0~\\epsilon / \\mathcal{L} \\rightarrow f=9~\\epsilon / \\mathcal{L}$"  ,\
"../../data/Urew/hist_3903_3003.dat" u 0:15 w l dt 1 lc 6 lw 5 title "Simulation$: f=0~\\epsilon / \\mathcal{L}$" ,\
"../../data/Urew/hist_3003_3903.dat" u 0:15 w l dt 1 lc 7 lw 5 title "Simulation$: f=9~\\epsilon / \\mathcal{L}$"  
