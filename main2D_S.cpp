...
//int find_core_ms(vector <double > & x, vector<int> & MS,vector <double> & box, vector <double> & shift)
//{
//2D spaeter
...
//	char *const fmt= (char*) "%8.3f ";
//	char *const fmtend= (char*) "%8.3f \n";
	MPI_Request request;
	double writev[4];
	int kk = int_steps /10;
	int ms2 = ms*ms;
	int start;
//	char *data_as_txt = (char*) malloc(5*charspernum*sizeof(char));
